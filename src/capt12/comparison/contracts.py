...
def default_method_contracts() -> list[MethodContract]:
    ...
    return [
        ...
        MethodContract(
            ...
            "robust profile privacy after exact frozen-channel verification",
            ("Z", "B", "S"),
            False,
            True,
            12,
            ...
            "MaSS MI controls are not privacy claims; each plotted point requires its own robust certificate",
        ),
        MethodContract(
            "mass12_calibrated",
